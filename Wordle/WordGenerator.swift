...
class WordGenerator {
  ...
  static let possibleWords = [ "ABCDE", "APPLE", "BRAIN", "CLOUD", "DRIVE", "EARTH", "FLOP", "GRAIN", "HAPPY", "INTER", "JOKER", "KARMA", "LOVELY", "MOTEL", "NINJA", "OPERA", "PEACE", "QUIET", "RIVAL", "SNEAK", "TIGER", "UNITY", "VITAL", "WALKY", "XENON", "YOUNG", "ZEALOUS", "ZEBRA"]
